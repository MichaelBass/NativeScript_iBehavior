...
const routes: Routes = [
    ...
    { path: "form2/:form_name", component: ItemDetailComponent },
    { path: "form2/:form_name/:position", component: ItemDetailComponent },
    { path: "form/:form_name", component: ItemDetail2Component },
    { path: "form/:form_name/:position", component: ItemDetail2Component },
